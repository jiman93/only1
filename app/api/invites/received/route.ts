...
export async function GET(request: Request) {
  ...
  // Filter received invites
  const receivedInvites: Invite[] = entries.filter((invite) => invite.inviteeId === userId);
  ...
  const invitesForPage = receivedInvites.slice(startIndex, endIndex);
